/*
 * AUTHOR : Julien Loudet <loudet.julien@gmail.com>
 *
 * PROBLEM ====================================================================
 * N      : 11
 * SUBJECT: What is the greatest product of four adjacent numbers in the same
...
enum Direction {HORIZONTAL, VERTICAL, DIAGONAL_RIGHT, DIAGONAL_LEFT};
const static int grid_size = 20;
const static int scan_iter_max = grid_size-3;
const static int grid[grid_size][grid_size] = {
...
void scan_grid(Direction dir, long *dir_product)
{
    long product;
